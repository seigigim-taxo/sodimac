...
export class SqliteConteoRepository implements ConteoRepository {
  ...
  async upsert(
     ...
     *
     * Hoy no debería encontrar líneas cerradas —cada apertura de TAG es una
     * ubicación nueva—, pero mirar la misma tupla que el índice es lo correcto
     * igual: si alguna vez vuelven a coincidir, esto lo resuelve o lo explica.
     */
