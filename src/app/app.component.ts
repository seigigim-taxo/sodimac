...
import { arrowBackOutline, logOutOutline, sunnyOutline, moonOutline, listOutline, homeOutline, cloudUploadOutline, cloudOfflineOutline, statsChartOutline, syncOutline, saveOutline } from 'ionicons/icons';
...
export class AppComponent {
  ...
  constructor() {
    addIcons({
      ...
      homeOutline, cloudUploadOutline, cloudOfflineOutline, statsChartOutline, syncOutline, saveOutline,
    });
